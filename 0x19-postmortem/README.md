...
![A graduation project postmortem.](https://github.com/user-attachments/assets/275dd7bc-8498-438f-acfc-3fef03b607a5)

## Postmortem: Graduation Project Deployment Incident

### Issue Summary
**Duration of the Outage:** 30 minutes (8:00 AM - 8:30 AM GMT)
...
### Timeline
- **8:00 AM GMT:** Issue detected by a team member during a pre-presentation check.
- **8:05 AM GMT:** Team member noticed the new feature was not functioning as expected.
- **8:15 AM GMT:** Realized the issue was due to URLs pointing to localhost in the JavaScript files.
- **8:18 AM GMT:** Ran the `sed` command to replace localhost URLs with the production domain in all files.
- **8:22 AM GMT:** Pushed changes to the repository.
- **8:27 AM GMT:** CI/CD pipeline deployed the changes.
- **8:30 AM GMT:** Verified that the new feature was functioning correctly on the production domain.
...
By addressing these areas, we can prevent similar issues in the future and ensure a smoother deployment process.
